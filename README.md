...
>   pilares de la portada ya eran tarjetas propias en rejilla (`.pilar` en
>   `estilos.css`); panorama, radar y señal lo son ahora también, en `.bento-home`:
>   panorama ocupa la celda ancha —lleva el gráfico— y radar y señal caen debajo a
>   mitades, con el mismo lenguaje visual que `.pilar` —borde, fondo, radio, sin
>   divisores— y la misma micro-interacción de borde y fondo al posar el cursor. Por
>   debajo de 960 px se apila a una columna. Falta el resto de vistas. Y, *solo si el
>   presupuesto del banner lo admite*, parallax en el hero: el árbol entero y sus
>   28 px de holgura valen más que un efecto de scroll, de modo que en el choque el
>   efecto es lo que cae.
>
