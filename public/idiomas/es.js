...
export default {
  ...
  // entero, no lo complementa (decisión explícita, no un olvido de la cláusula de
  // cotizaciones con retardo que llevaba antes).
  'pie.aviso': 'Esto es research, no asesoramiento de inversión. Las tesis reflejan el criterio de quien las firma. La cartera se calcula automáticamente a partir de lo publicado, sesión a sesión, sin intervención manual sobre el resultado.',
  ...
  // El hero vuelve a no tener texto: la fotografía es el hero entero, igual
  // que en la Fase D.13. `portada.hero.titular` y `portada.hero.bajada`, las
  // dos claves que el rediseño 3 añadió para su hero tipográfico, se retiran
  // con él. Tampoco se reponen las de la Fase D.6 —`portada.manifiesto.titular`
  // y `portada.hero.subtitulo`—: aquellas ya se habían retirado en D.13 y
  // nadie las ha pedido de vuelta.
  ...
  'informe.tipo.inicioCobertura': 'Inicio de cobertura',
  'informe.tipo.actualizacionResultados': 'Actualización de resultados',
  'informe.tipo.notaSectorial': 'Nota sectorial',
  'informe.tipo.notaMacro': 'Nota macroeconómica',
  'informe.tipo.revisionValoracion': 'Revisión de valoración',
  'informe.tipo.analisisTecnico': 'Análisis técnico',
  'informe.tipo.dueDiligence': 'Due diligence',

  'informe.recomendacion.comprar': 'Comprar',
  'informe.recomendacion.sobreponderar': 'Sobreponderar',
  'informe.recomendacion.mantener': 'Mantener',
  'informe.recomendacion.infraponderar': 'Infraponderar',
  'informe.recomendacion.vender': 'Vender',
  'informe.recomendacion.enRevision': 'En revisión',

  'informe.sector.tecnologia': 'Tecnología de la información',
  'informe.sector.salud': 'Salud',
  'informe.sector.financiero': 'Financiero',
  'informe.sector.consumoDiscrecional': 'Consumo discrecional',
  'informe.sector.consumoBasico': 'Consumo básico',
  'informe.sector.energia': 'Energía',
  'informe.sector.industriales': 'Industriales',
  'informe.sector.materiales': 'Materiales',
  'informe.sector.comunicacion': 'Servicios de comunicación',
  'informe.sector.utilities': 'Utilities',
  'informe.sector.inmobiliario': 'Inmobiliario',
