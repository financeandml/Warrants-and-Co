...
export default {
  ...
  'cartera.subtitulo': 'An up-to-date summary of the portfolio and its performance.',
  ...
  'cartera.posiciones.lista.subtitulo': 'Every published thesis, open or closed, with its real weight and its real contribution to return.',
  'cartera.posiciones.col.peso': 'Weight',
  'cartera.posiciones.cierre': 'Closed on {fecha} · {motivo}',
  'cartera.posiciones.detalle.ver': 'Detail',
  'cartera.posiciones.detalle.ocultar': 'Hide detail',
